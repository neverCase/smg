...
type LoadLoRAAdapterRequest struct {
	...
	LoraName string `protobuf:"bytes,1,opt,name=lora_name,json=loraName,proto3" json:"lora_name,omitempty"`
	// Local directory containing the adapter weights. Must be readable
	// by the engine process (shared volume).
	LoraPath string `protobuf:"bytes,2,opt,name=lora_path,json=loraPath,proto3" json:"lora_path,omitempty"`
	...
	LoraId        string `protobuf:"bytes,4,opt,name=lora_id,json=loraId,proto3" json:"lora_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *LoadLoRAAdapterRequest) Reset() {
	*x = LoadLoRAAdapterRequest{}
	mi := &file_sglang_scheduler_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LoadLoRAAdapterRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoadLoRAAdapterRequest) ProtoMessage() {}

func (x *LoadLoRAAdapterRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sglang_scheduler_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoadLoRAAdapterRequest.ProtoReflect.Descriptor instead.
func (*LoadLoRAAdapterRequest) Descriptor() ([]byte, []int) {
...
func (x *LoadLoRAAdapterRequest) GetPinned() bool {
	if x != nil {
		return x.Pinned
	}
	return false
...
func (x *LoadLoRAAdapterRequest) GetLoraId() string {
	if x != nil {
		return x.LoraId
	}
	return ""
...
type LoadLoRAAdapterResponse struct {
	state   protoimpl.MessageState `protogen:"open.v1"`
	Success bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	...
	LoadedLoraIds []string `protobuf:"bytes,3,rep,name=loaded_lora_ids,json=loadedLoraIds,proto3" json:"loaded_lora_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *LoadLoRAAdapterResponse) Reset() {
	*x = LoadLoRAAdapterResponse{}
	mi := &file_sglang_scheduler_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LoadLoRAAdapterResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoadLoRAAdapterResponse) ProtoMessage() {}

func (x *LoadLoRAAdapterResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sglang_scheduler_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoadLoRAAdapterResponse.ProtoReflect.Descriptor instead.
func (*LoadLoRAAdapterResponse) Descriptor() ([]byte, []int) {
	return file_sglang_scheduler_proto_rawDescGZIP(), []int{22}
}

func (x *LoadLoRAAdapterResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *LoadLoRAAdapterResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *LoadLoRAAdapterResponse) GetLoadedLoraIds() []string {
	if x != nil {
		return x.LoadedLoraIds
	}
	return nil
}
...
type UnloadLoRAAdapterRequest struct {
	...
	// together.
	LoraId        string `protobuf:"bytes,2,opt,name=lora_id,json=loraId,proto3" json:"lora_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UnloadLoRAAdapterRequest) Reset() {
	*x = UnloadLoRAAdapterRequest{}
	mi := &file_sglang_scheduler_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UnloadLoRAAdapterRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnloadLoRAAdapterRequest) ProtoMessage() {}

func (x *UnloadLoRAAdapterRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sglang_scheduler_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UnloadLoRAAdapterRequest.ProtoReflect.Descriptor instead.
func (*UnloadLoRAAdapterRequest) Descriptor() ([]byte, []int) {
...
func (x *UnloadLoRAAdapterRequest) GetLoraId() string {
	if x != nil {
		return x.LoraId
	}
	return ""
...
type UnloadLoRAAdapterResponse struct {
	state   protoimpl.MessageState `protogen:"open.v1"`
	Success bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	// Status or error description; empty on success.
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
...
func (x *UnloadLoRAAdapterResponse) Reset() {
	*x = UnloadLoRAAdapterResponse{}
	mi := &file_sglang_scheduler_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UnloadLoRAAdapterResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnloadLoRAAdapterResponse) ProtoMessage() {}

func (x *UnloadLoRAAdapterResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sglang_scheduler_proto_msgTypes[24]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UnloadLoRAAdapterResponse.ProtoReflect.Descriptor instead.
func (*UnloadLoRAAdapterResponse) Descriptor() ([]byte, []int) {
	return file_sglang_scheduler_proto_rawDescGZIP(), []int{24}
}

func (x *UnloadLoRAAdapterResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *UnloadLoRAAdapterResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *UnloadLoRAAdapterResponse) GetLoadedLoraIds() []string {
	if x != nil {
		return x.LoadedLoraIds
	}
	return nil
...
func (x *ListLoadedLoRAAdaptersRequest) Reset() {
	*x = ListLoadedLoRAAdaptersRequest{}
	mi := &file_sglang_scheduler_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListLoadedLoRAAdaptersRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListLoadedLoRAAdaptersRequest) ProtoMessage() {}

func (x *ListLoadedLoRAAdaptersRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sglang_scheduler_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListLoadedLoRAAdaptersRequest.ProtoReflect.Descriptor instead.
func (*ListLoadedLoRAAdaptersRequest) Descriptor() ([]byte, []int) {
...
func (x *LoadedLoRAAdapter) Reset() {
	*x = LoadedLoRAAdapter{}
...
func (x *LoadedLoRAAdapter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoadedLoRAAdapter) ProtoMessage() {}

func (x *LoadedLoRAAdapter) ProtoReflect() protoreflect.Message {
	mi := &file_sglang_scheduler_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoadedLoRAAdapter.ProtoReflect.Descriptor instead.
func (*LoadedLoRAAdapter) Descriptor() ([]byte, []int) {
	return file_sglang_scheduler_proto_rawDescGZIP(), []int{26}
}

func (x *LoadedLoRAAdapter) GetLoraId() string {
	if x != nil {
		return x.LoraId
	}
	return ""
...
func (x *LoadedLoRAAdapter) GetLoraName() string {
	if x != nil {
		return x.LoraName
	}
	return ""
...
func (x *LoadedLoRAAdapter) GetLoraPath() string {
	if x != nil {
		return x.LoraPath
	}
	return ""
...
func (x *LoadedLoRAAdapter) GetPinned() bool {
	if x != nil {
		return x.Pinned
	}
	return false
...
type ListLoadedLoRAAdaptersResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	LoadedAdapters []*LoadedLoRAAdapter   `protobuf:"bytes,1,rep,name=loaded_adapters,json=loadedAdapters,proto3" json:"loaded_adapters,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *ListLoadedLoRAAdaptersResponse) Reset() {
	*x = ListLoadedLoRAAdaptersResponse{}
	mi := &file_sglang_scheduler_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListLoadedLoRAAdaptersResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListLoadedLoRAAdaptersResponse) ProtoMessage() {}

func (x *ListLoadedLoRAAdaptersResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sglang_scheduler_proto_msgTypes[27]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListLoadedLoRAAdaptersResponse.ProtoReflect.Descriptor instead.
func (*ListLoadedLoRAAdaptersResponse) Descriptor() ([]byte, []int) {
	return file_sglang_scheduler_proto_rawDescGZIP(), []int{27}
}

func (x *ListLoadedLoRAAdaptersResponse) GetLoadedAdapters() []*LoadedLoRAAdapter {
	if x != nil {
		return x.LoadedAdapters
	}
	return nil
}
...
func (x *AggregateMetrics) Reset() {
	*x = AggregateMetrics{}
	mi := &file_sglang_scheduler_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AggregateMetrics) Descriptor() ([]byte, []int) {
	return file_sglang_scheduler_proto_rawDescGZIP(), []int{46}
}
...
const file_sglang_scheduler_proto_rawDesc = "" +
	...
	"\x16LoadLoRAAdapterRequest\x12\x1b\n" +
	"\tlora_name\x18\x01 \x01(\tR\bloraName\x12\x1b\n" +
	"\tlora_path\x18\x02 \x01(\tR\bloraPath\x12\x16\n" +
	"\x06pinned\x18\x03 \x01(\bR\x06pinned\x12\x17\n" +
	"\alora_id\x18\x04 \x01(\tR\x06loraId\"u\n" +
	"\x17LoadLoRAAdapterResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12&\n" +
	"\x0floaded_lora_ids\x18\x03 \x03(\tR\rloadedLoraIds\"P\n" +
	"\x18UnloadLoRAAdapterRequest\x12\x1b\n" +
	"\tlora_name\x18\x01 \x01(\tR\bloraName\x12\x17\n" +
	"\alora_id\x18\x02 \x01(\tR\x06loraId\"w\n" +
	"\x19UnloadLoRAAdapterResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12&\n" +
	"\x0floaded_lora_ids\x18\x03 \x03(\tR\rloadedLoraIds\"\x1f\n" +
	"\x1dListLoadedLoRAAdaptersRequest\"~\n" +
	"\x11LoadedLoRAAdapter\x12\x17\n" +
	"\alora_id\x18\x01 \x01(\tR\x06loraId\x12\x1b\n" +
	"\tlora_name\x18\x02 \x01(\tR\bloraName\x12\x1b\n" +
	"\tlora_path\x18\x03 \x01(\tR\bloraPath\x12\x16\n" +
	"\x06pinned\x18\x04 \x01(\bR\x06pinned\"s\n" +
	"\x1eListLoadedLoRAAdaptersResponse\x12Q\n" +
	"\x0floaded_adapters\x18\x01 \x03(\v2(.sglang.grpc.scheduler.LoadedLoRAAdapterR\x0eloadedAdapters\"\xa4\x01\n" +
	...
	"\x0favg_utilization\x18\x06 \x01(\x01R\x0eavgUtilization2\xe4\v\n" +
	...
	"\x11SubscribeKvEvents\x12).smg.grpc.common.SubscribeKvEventsRequest\x1a\x1d.smg.grpc.common.KvEventBatch0\x01\x12p\n" +
	"\x0fLoadLoRAAdapter\x12-.sglang.grpc.scheduler.LoadLoRAAdapterRequest\x1a..sglang.grpc.scheduler.LoadLoRAAdapterResponse\x12v\n" +
	"\x11UnloadLoRAAdapter\x12/.sglang.grpc.scheduler.UnloadLoRAAdapterRequest\x1a0.sglang.grpc.scheduler.UnloadLoRAAdapterResponse\x12\x85\x01\n" +
	"\x16ListLoadedLoRAAdapters\x124.sglang.grpc.scheduler.ListLoadedLoRAAdaptersRequest\x1a5.sglang.grpc.scheduler.ListLoadedLoRAAdaptersResponseb\x06proto3"
...
var file_sglang_scheduler_proto_msgTypes = make([]protoimpl.MessageInfo, 49)
var file_sglang_scheduler_proto_goTypes = []any{
	...
	(*LoadLoRAAdapterRequest)(nil),         // 21: sglang.grpc.scheduler.LoadLoRAAdapterRequest
	(*LoadLoRAAdapterResponse)(nil),        // 22: sglang.grpc.scheduler.LoadLoRAAdapterResponse
	(*UnloadLoRAAdapterRequest)(nil),       // 23: sglang.grpc.scheduler.UnloadLoRAAdapterRequest
	(*UnloadLoRAAdapterResponse)(nil),      // 24: sglang.grpc.scheduler.UnloadLoRAAdapterResponse
	(*ListLoadedLoRAAdaptersRequest)(nil),  // 25: sglang.grpc.scheduler.ListLoadedLoRAAdaptersRequest
	(*LoadedLoRAAdapter)(nil),              // 26: sglang.grpc.scheduler.LoadedLoRAAdapter
	(*ListLoadedLoRAAdaptersResponse)(nil), // 27: sglang.grpc.scheduler.ListLoadedLoRAAdaptersResponse
	(*UpdateWeightsRequest)(nil),           // 28: sglang.grpc.scheduler.UpdateWeightsRequest
	(*UpdateWeightsResponse)(nil),          // 29: sglang.grpc.scheduler.UpdateWeightsResponse
	(*GetInternalStateRequest)(nil),        // 30: sglang.grpc.scheduler.GetInternalStateRequest
	(*GetInternalStateResponse)(nil),       // 31: sglang.grpc.scheduler.GetInternalStateResponse
	(*SetInternalStateRequest)(nil),        // 32: sglang.grpc.scheduler.SetInternalStateRequest
	(*SetInternalStateResponse)(nil),       // 33: sglang.grpc.scheduler.SetInternalStateResponse
	(*GetModelInfoRequest)(nil),            // 34: sglang.grpc.scheduler.GetModelInfoRequest
	(*GetModelInfoResponse)(nil),           // 35: sglang.grpc.scheduler.GetModelInfoResponse
	(*GetServerInfoRequest)(nil),           // 36: sglang.grpc.scheduler.GetServerInfoRequest
	(*GetServerInfoResponse)(nil),          // 37: sglang.grpc.scheduler.GetServerInfoResponse
	(*GetLoadsRequest)(nil),                // 38: sglang.grpc.scheduler.GetLoadsRequest
	(*GetLoadsResponse)(nil),               // 39: sglang.grpc.scheduler.GetLoadsResponse
	(*SchedulerLoad)(nil),                  // 40: sglang.grpc.scheduler.SchedulerLoad
	(*MemoryMetrics)(nil),                  // 41: sglang.grpc.scheduler.MemoryMetrics
	(*SpeculativeMetrics)(nil),             // 42: sglang.grpc.scheduler.SpeculativeMetrics
	(*LoRAMetrics)(nil),                    // 43: sglang.grpc.scheduler.LoRAMetrics
	(*DisaggregationMetrics)(nil),          // 44: sglang.grpc.scheduler.DisaggregationMetrics
	(*QueueMetrics)(nil),                   // 45: sglang.grpc.scheduler.QueueMetrics
	(*AggregateMetrics)(nil),               // 46: sglang.grpc.scheduler.AggregateMetrics
	nil,                                    // 47: sglang.grpc.scheduler.SamplingParams.LogitBiasEntry
	nil,                                    // 48: sglang.grpc.scheduler.MultimodalInputs.ModelSpecificTensorsEntry
	(*structpb.Struct)(nil),                // 49: google.protobuf.Struct
	(*timestamppb.Timestamp)(nil),          // 50: google.protobuf.Timestamp
	(*FlushCacheRequest)(nil),              // 51: smg.grpc.common.FlushCacheRequest
	(*StartProfileRequest)(nil),            // 52: smg.grpc.common.StartProfileRequest
	(*StopProfileRequest)(nil),             // 53: smg.grpc.common.StopProfileRequest
	(*GetTokenizerRequest)(nil),            // 54: smg.grpc.common.GetTokenizerRequest
	(*SubscribeKvEventsRequest)(nil),       // 55: smg.grpc.common.SubscribeKvEventsRequest
	(*FlushCacheResponse)(nil),             // 56: smg.grpc.common.FlushCacheResponse
	(*ProfileResponse)(nil),                // 57: smg.grpc.common.ProfileResponse
	(*GetTokenizerChunk)(nil),              // 58: smg.grpc.common.GetTokenizerChunk
	(*KvEventBatch)(nil),                   // 59: smg.grpc.common.KvEventBatch
}
var file_sglang_scheduler_proto_depIdxs = []int32{
	47, // 0: sglang.grpc.scheduler.SamplingParams.logit_bias:type_name -> sglang.grpc.scheduler.SamplingParams.LogitBiasEntry
	49, // 1: sglang.grpc.scheduler.SamplingParams.custom_params:type_name -> google.protobuf.Struct
	...
	50, // 6: sglang.grpc.scheduler.GenerateRequest.timestamp:type_name -> google.protobuf.Timestamp
	4,  // 7: sglang.grpc.scheduler.MultimodalInputs.pixel_values:type_name -> sglang.grpc.scheduler.TensorData
	48, // 8: sglang.grpc.scheduler.MultimodalInputs.model_specific_tensors:type_name -> sglang.grpc.scheduler.MultimodalInputs.ModelSpecificTensorsEntry
	...
	26, // 23: sglang.grpc.scheduler.ListLoadedLoRAAdaptersResponse.loaded_adapters:type_name -> sglang.grpc.scheduler.LoadedLoRAAdapter
	49, // 24: sglang.grpc.scheduler.GetInternalStateResponse.state:type_name -> google.protobuf.Struct
	49, // 25: sglang.grpc.scheduler.SetInternalStateRequest.state:type_name -> google.protobuf.Struct
	49, // 26: sglang.grpc.scheduler.GetServerInfoResponse.server_args:type_name -> google.protobuf.Struct
	49, // 27: sglang.grpc.scheduler.GetServerInfoResponse.scheduler_info:type_name -> google.protobuf.Struct
	50, // 28: sglang.grpc.scheduler.GetServerInfoResponse.start_time:type_name -> google.protobuf.Timestamp
	40, // 29: sglang.grpc.scheduler.GetLoadsResponse.loads:type_name -> sglang.grpc.scheduler.SchedulerLoad
	46, // 30: sglang.grpc.scheduler.GetLoadsResponse.aggregate:type_name -> sglang.grpc.scheduler.AggregateMetrics
	41, // 31: sglang.grpc.scheduler.SchedulerLoad.memory:type_name -> sglang.grpc.scheduler.MemoryMetrics
	42, // 32: sglang.grpc.scheduler.SchedulerLoad.speculative:type_name -> sglang.grpc.scheduler.SpeculativeMetrics
	43, // 33: sglang.grpc.scheduler.SchedulerLoad.lora:type_name -> sglang.grpc.scheduler.LoRAMetrics
	44, // 34: sglang.grpc.scheduler.SchedulerLoad.disaggregation:type_name -> sglang.grpc.scheduler.DisaggregationMetrics
	45, // 35: sglang.grpc.scheduler.SchedulerLoad.queues:type_name -> sglang.grpc.scheduler.QueueMetrics
	4,  // 36: sglang.grpc.scheduler.MultimodalInputs.ModelSpecificTensorsEntry.value:type_name -> sglang.grpc.scheduler.TensorData
	2,  // 37: sglang.grpc.scheduler.SglangScheduler.Generate:input_type -> sglang.grpc.scheduler.GenerateRequest
	15, // 38: sglang.grpc.scheduler.SglangScheduler.Embed:input_type -> sglang.grpc.scheduler.EmbedRequest
	17, // 39: sglang.grpc.scheduler.SglangScheduler.HealthCheck:input_type -> sglang.grpc.scheduler.HealthCheckRequest
	19, // 40: sglang.grpc.scheduler.SglangScheduler.Abort:input_type -> sglang.grpc.scheduler.AbortRequest
	34, // 41: sglang.grpc.scheduler.SglangScheduler.GetModelInfo:input_type -> sglang.grpc.scheduler.GetModelInfoRequest
	36, // 42: sglang.grpc.scheduler.SglangScheduler.GetServerInfo:input_type -> sglang.grpc.scheduler.GetServerInfoRequest
	38, // 43: sglang.grpc.scheduler.SglangScheduler.GetLoads:input_type -> sglang.grpc.scheduler.GetLoadsRequest
	51, // 44: sglang.grpc.scheduler.SglangScheduler.FlushCache:input_type -> smg.grpc.common.FlushCacheRequest
	52, // 45: sglang.grpc.scheduler.SglangScheduler.StartProfile:input_type -> smg.grpc.common.StartProfileRequest
	53, // 46: sglang.grpc.scheduler.SglangScheduler.StopProfile:input_type -> smg.grpc.common.StopProfileRequest
	54, // 47: sglang.grpc.scheduler.SglangScheduler.GetTokenizer:input_type -> smg.grpc.common.GetTokenizerRequest
	55, // 48: sglang.grpc.scheduler.SglangScheduler.SubscribeKvEvents:input_type -> smg.grpc.common.SubscribeKvEventsRequest
	21, // 49: sglang.grpc.scheduler.SglangScheduler.LoadLoRAAdapter:input_type -> sglang.grpc.scheduler.LoadLoRAAdapterRequest
	23, // 50: sglang.grpc.scheduler.SglangScheduler.UnloadLoRAAdapter:input_type -> sglang.grpc.scheduler.UnloadLoRAAdapterRequest
	25, // 51: sglang.grpc.scheduler.SglangScheduler.ListLoadedLoRAAdapters:input_type -> sglang.grpc.scheduler.ListLoadedLoRAAdaptersRequest
	7,  // 52: sglang.grpc.scheduler.SglangScheduler.Generate:output_type -> sglang.grpc.scheduler.GenerateResponse
	16, // 53: sglang.grpc.scheduler.SglangScheduler.Embed:output_type -> sglang.grpc.scheduler.EmbedResponse
	18, // 54: sglang.grpc.scheduler.SglangScheduler.HealthCheck:output_type -> sglang.grpc.scheduler.HealthCheckResponse
	20, // 55: sglang.grpc.scheduler.SglangScheduler.Abort:output_type -> sglang.grpc.scheduler.AbortResponse
	35, // 56: sglang.grpc.scheduler.SglangScheduler.GetModelInfo:output_type -> sglang.grpc.scheduler.GetModelInfoResponse
	37, // 57: sglang.grpc.scheduler.SglangScheduler.GetServerInfo:output_type -> sglang.grpc.scheduler.GetServerInfoResponse
	39, // 58: sglang.grpc.scheduler.SglangScheduler.GetLoads:output_type -> sglang.grpc.scheduler.GetLoadsResponse
	56, // 59: sglang.grpc.scheduler.SglangScheduler.FlushCache:output_type -> smg.grpc.common.FlushCacheResponse
	57, // 60: sglang.grpc.scheduler.SglangScheduler.StartProfile:output_type -> smg.grpc.common.ProfileResponse
	57, // 61: sglang.grpc.scheduler.SglangScheduler.StopProfile:output_type -> smg.grpc.common.ProfileResponse
	58, // 62: sglang.grpc.scheduler.SglangScheduler.GetTokenizer:output_type -> smg.grpc.common.GetTokenizerChunk
	59, // 63: sglang.grpc.scheduler.SglangScheduler.SubscribeKvEvents:output_type -> smg.grpc.common.KvEventBatch
	22, // 64: sglang.grpc.scheduler.SglangScheduler.LoadLoRAAdapter:output_type -> sglang.grpc.scheduler.LoadLoRAAdapterResponse
	24, // 65: sglang.grpc.scheduler.SglangScheduler.UnloadLoRAAdapter:output_type -> sglang.grpc.scheduler.UnloadLoRAAdapterResponse
	27, // 66: sglang.grpc.scheduler.SglangScheduler.ListLoadedLoRAAdapters:output_type -> sglang.grpc.scheduler.ListLoadedLoRAAdaptersResponse
...
func file_sglang_scheduler_proto_init() {
	...
	file_sglang_scheduler_proto_msgTypes[28].OneofWrappers = []any{
		(*UpdateWeightsRequest_DiskPath)(nil),
		(*UpdateWeightsRequest_TensorData)(nil),
		(*UpdateWeightsRequest_RemoteUrl)(nil),
	}
	file_sglang_scheduler_proto_msgTypes[38].OneofWrappers = []any{}
	file_sglang_scheduler_proto_msgTypes[40].OneofWrappers = []any{}
	type x struct{}
